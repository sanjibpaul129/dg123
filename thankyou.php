...
<!-- End Google Tag Manager -->
		...
		<style>
            ...
            body{
                background:url(https://dreamone.co.in/overview2.jpg)
            }
            .social-bar {
              position: fixed;
              top: 50%;
...
<div class="container-fluid" style="text-align: center; padding: 95px 15px 0;">
	...
	<a href="https://dreamone.co.in/" style="background: #071c35;color: white;text-transform: capitalize;padding: 13px 20px;font-size: 15px;margin: 20px auto;display: table;">back to home</a>
        ...
        <!--banner-->
        <!--<div class="sp-banner" style="text-align:center">
            <a href="https://dreamone.co.in/"><img src="thankyou.png" class="img-responsive" style="margin: 0 auto;" /></a>
        </div>-->
        <!--/banner-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3 hidden-xs">
                        <h4>
                            <br />
                            <!--<a href="#" class="spec-comm-link"><i class="fa fa-arrow-left" aria-hidden="true"></i> Downtown Brochure</a>-->
                        </h4>
                    ...
                    <div class="modal-body">
						<form id="loginform" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" minlength="6" required name="name" id="name" placeholder="Enter Full Name" />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required maxlength="10" name="contact" id="contact" onKeyUp="this.value=this.value.replace(/[^0-9+ ]+/g,'');" placeholder="Enter Your 10 Digit Phone Number" pattern="[1-9]{1}[0-9]{9}"  />
                            </div>
                            <div class="form-group">
                                <label>PROJECT <span>*</span></label>
                                <input type="text" class="form-control" name="project" id="project" value="Dream One" placeholder="Dream One" readonly />
                            </div>
                            <div class="form-group">
                            ...
                            $(document).ready(function () {
                                $("#loginform").submit(function (e) {
                                    ...
                                    $.ajax({
									 ...
									 $.ajax({
                                        type: "POST",
                                        url: "https://vtsinfotech.in/dreamone/login.php",
                                        data: $(this).serialize(),
                                        success: function (response) {
									...
									location.href = "https://dreamone.co.in/thankyou.php";
										...
										//alert("Thank you very much for your interest in DREAM ONE APARTMENT. Our customer relation executive will get back to you shortly. You can also call us @ 9681 711 711 or mail us at marketing@thejaingroup.com");
                                    		//location.href = "https://dreamone.co.in/thankyou.html";
...
window.onload = function() {
    document.getElementById('loginform').onsubmit = validateEmail;
}
</script>
                    </div>
                </div>
...
<!--<a style="position: fixed; right: 0; top: 70%; z-index: 9999; width: 37px;" href="https://wa.me/919831282170?text=Interested%20in%20Dream%20One" target="_blank">
